      ...
      {loading ? (
        <div className="space-y-6">
          <div className={cn(
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <Card key={i}>
                <CardContent className="p-5 h-[110px] bg-muted/30" />
              </Card>
            ))}
          </div>
        ...
        <>
          ...
          <div className={cn(
            ...
            {/* Pie & Bar Charts - sama seperti sebelumnya tapi add className */}
            {/* ... (rest of charts, just add hover:shadow-md & border-border/50 ke Card) */}
          </div>
